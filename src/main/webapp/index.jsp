...
<div class="container">
  ...
  <div class="row">
      <div class="span4">
          <%
              if(request.getSession(true).getAttribute("listOfBlogs") != null) {
                List<String> listOfBlogs = (List)request.getSession().getAttribute("listOfBlogs");
                for(String blogName:listOfBlogs){
                  out.write("<p>" +blogName);
                }
          }
          %>
      ...
      <div class="span4">
          <form action="<%= WebUtil.buildUrl(request, "/main") %>" method="post">
              ...
              <button class="btn btn-block btn-success" type="submit">
                  post the content above to blog
              </button>
          </form>
