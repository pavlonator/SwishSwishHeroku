...
public class DealAlertFromGlassServlet  extends HttpServlet {
	...
	protected void execute(HttpServletRequest request,
		...
		try {
			...
			String json = "{\"address\":\""+address+"\", \"comment\":\""+comment+"\"}";
			
			
			String sfUrl = "https://na17.salesforce.com/services/apexrest/GlassMessages/dealAlertFromHeroku";
			String contentType = "application/json";
			String authorization = "Bearer " + accessToken;
			System.out.println(interract(json, sfUrl, contentType, authorization));
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
	...
	private String interract(String urlParameters, String requestUrl,
			String contentType, String authorization) throws MalformedURLException, IOException,
			ProtocolException {
